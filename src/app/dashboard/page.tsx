          ...
          <div className="space-y-3">
            {businesses.map((b) => (
              <div key={b.id} className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm">
                <Link href={`/dashboard/${b.id}`} className="flex items-center justify-between p-5 active:bg-slate-50">
                  ...
                  <svg className="w-4 h-4 text-slate-200 shrink-0 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
